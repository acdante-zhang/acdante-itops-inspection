...
-- |    :                                                                    |
-- |    E-mail：                                        |
-- |    BLOG: https://www.oracle.com                                            |
-- |------------------------------------------------------------------------------------|
-- |                 Copyright (c) 2015-2100 dhch. All rights reserved.                  |
-- |------------------------------------------------------------------------------------|
-- | DATABASE : Oracle                                                                  |
-- | FILE     : DB_Oracle_HC_dhch_v7.0.0_12c.sql                                         |
...
-- | VERSION  : This script was designed for Oracle Database 12c、18c、19c，and so on.  |
-- | USAGE    :                                                                         |
-- | sqlplus <dba_user>/<password>@DB_IP/SERVICE_NAME @DB_Oracle_HC_dhch_v7.0.0_12c.sql  |
-- |                                                                                    |
...
prompt |------------------------------------------------------------------------------------------------------------+	
prompt |  Copyright (c) 2015-2100 dhch. All rights reserved. (Address: https://www.oracle.com)       |	
prompt +------------------------------------------------------------------------------------------------------------+	
prompt |  About Me: Oracle   :                                                           |	
prompt +------------------------------------------------------------------------------------------------------------+	
prompt


prompt Note: Do not modify any inspection results 
prompt Please send the file of DB_healthcheck_by_dhch_dbname_YYYYMMDD.html to dhchbest@.com or ()
prompt

prompt 数据库巡检脚本  编写者：Oracle [版权所有 侵权必究] : 
prompt 说明：
...
SET APPINFO 'DB_HEALTHCHECK_dhch'


--记录SQLPLUS 错误日志
set termout       off
set errorlogging on
set errorlogging on TABLE SPERRORLOG identifier dhch_DB_HEALTHCHECK
delete from sperrorlog where identifier='dhch_DB_HEALTHCHECK';
COMMIT;
...
SELECT DECODE((SELECT b.parallel FROM v$instance b), 'YES', (d.NAME || '_' ||  (SELECT b.INSTANCE_NUMBER FROM v$instance b)), 'NO', d.NAME)   dbname1,  
       name dbname,
       dbid dbid,
       'DB_healthcheck_by_dhch_' || name || '_' ||DECODE((SELECT b.parallel FROM v$instance b), 'YES', (SELECT b.INSTANCE_NUMBER FROM v$instance b)|| '_', 'NO', '')  || (SELECT b.VERSION FROM v$instance b) || '_' ||TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS') reporttitle,
...
prompt <Marquee  align="absmiddle" scrolldelay="100" behavior="alternate" direction="left" onmouseover="this.stop()" onmouseout="this.start()" bgcolor="#FFCC00"  height=18 width=100%  vspace="1" hspace="1"><font face="Consolas" color="#008B00" size="2"> <div style="font-weight:lighter">巡检人:Oracle<font size="2">https://www.oracle.com</font></a> </div></font></Marquee>
...
prompt &reportHeader
prompt <hr>
prompt <div style="font-weight:lighter"><font face="Consolas" color="#336699">Copyright (c) 2015-2100 (https://www.oracle.com) <a target="_blank" href="https://www.oracle.com">Oracle</a>. All rights reserved.</font></div>
prompt <a style="font-weight:lighter">巡 检 人：Oracle</a>
prompt <a style="font-weight:lighter">巡检时间：&_date_time</a>
prompt <a style="font-weight:lighter">版 本 号：v7.0.0</a>
prompt <a style="font-weight:lighter">修改日期：2021-10-19 18:18:18</a>
prompt 
...
<td nowrap align="center" width="18%"><a class="info" href="#tablespaces_info"><font size=+0.5 face="Consolas" color="#336699">表空间状况信息<span>包含表空间的历史增长情况</span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_SGAINFOdhch"><font size=+0.5 face="Consolas" color="#000000"><b>SGA信息</b><span> </span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_statements_version_count10"><font size=+0.5 face="Consolas" color="#336699">版本TOP10的SQL语句<span>SQL ordered by Version Count</span></font></a></td> -
...
<tr><th align="left" width="150">是否CDB及其PDB个数</th><td width="950"><font face="Consolas">&_pdbs</font></td></tr> -
...
prompt <font size="+1" face="Consolas" color="#336699"><b>● PDB情况</b></font>
...
prompt <font size="+1" face="Consolas" color="#336699"><b>● Feature Usage Statistics</b></font>[<a class="noLink" href="#high_water_mark_statistics">下一项</a>] 
...
prompt <font size="+2" face="Consolas" color="#336699"><b>Libraries</b></font>[<a class="noLink" href="#spfile_info">下一项</a>] <hr align="left" width="600">
...
prompt <font size="+2" face="Consolas" color="#336699"><b>所有的初始化参数</b></font>  [<a class="noLink" href="#initial_parameter_info">下一项</a>] <hr align="left" width="600">
...
prompt <font size="+2" face="Consolas" color="#336699"><b>PDB参数</b></font></center><p> <hr align="left" width="600">
...
prompt <font size="1" face="Consolas" color="#990000">NOTE: 可根据视图cdb_hist_seg_stat和cdb_hist_seg_stat_obj详细分析数据库对象的增量情况</font>
...
prompt <font size="+1" face="Consolas" color="#336699"><b>● cdb_jobs </b></font>
...
prompt 
prompt <font size="+1" face="Consolas" color="#336699"><b>● cdb_scheduler_jobs </b></font>
...
prompt <font size="+2" face="Consolas" color="#336699"><b>数据库job报错信息</b></font> [<a class="noLink" href="#database_rmanbackinfo">下一项</a>]<hr align="left" width="600">
...
prompt <font size="+2" face="Consolas" color="#336699"><b>RMAN所有备份</b></font>[<a class="noLink" href="#rman_backupset_detail_info">下一项</a>]<hr align="left" width="600">
...
SELECT TAG,BS_key,
  ...
  LEFT OUTER JOIN v$backup_spfile e
    ON (a.SET_STAMP = e.SET_STAMP AND  a.SET_COUNT = e.SET_COUNT and a.CON_ID=e.con_id)
 ...
 GROUP BY BS_key,
          ...
          KEEP_OPTIONS,
					con_id
 ORDER BY substr(start_time,1,10) desc, BS_key , BP_key ,start_time,con_id  ;
...
prompt <font size="+2" face="Consolas" color="#336699"><b>RMAN所有备份详情</b></font>[<a class="noLink" href="#rman_backup_sets">下一项</a>]<hr align="left" width="600">
...
prompt <font size="+2" face="Consolas" color="#336699"><b>近7天日志切换频率分析</b></font> [<a class="noLink" href="#log_10_ratefenxiqiehuan">下一项</a>]<hr align="left" width="600">
...
-- +----------------------------------------------------------------------------+
host echo "            SGA信息. . ." 
prompt <a name="database_SGAINFOdhch"></a>
...
SELECT &_snap_id || '~' || &_snap_id1 snap_id_range,
  ...
  FROM (SELECT sql_id,
         ...
         WHERE &_snap_id < snap_id
           ...
           AND  a.parsing_schema_name NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT *
  FROM (SELECT d.INST_ID,
         ...
         WHERE D.USERNAME IS NOT NULL
           AND  d.USERNAME NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
		 )  
where rank_order <= 10;
...
with force_mathces as
 (select l.force_matching_signature,
   ...
   and l.parsing_schema_name  NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')
...
prompt ● gv$dataguard_process 查询进程信息
...
SELECT d.CON_ID, '<div nowrap align="left"><font color="#336699"><b>' || owner ||'</b></font></div>' owner,
       ...
       COUNT(1) counts
FROM   cdb_segments d
WHERE  owner NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')
...
SELECT d.CON_ID, table_name, owner, tablespace_name
 ...
 WHERE tablespace_name in ('SYSTEM')
   AND    owner NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') ;
...
SELECT d.CON_ID, 
 ...
 WHERE nb.OWNER = d.table_owner
   ...
   and d.tablespace_name in ('SYSTEM')
	 AND  d.owner NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG');
...
SELECT a.con_id, a.owner,
  ...
  FROM (SELECT b.CON_ID, b.owner,
               ...
               b.extents
          FROM cdb_segments b
	  WHERE    b.owner   NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT CON_ID,a.owner,
  ...
  FROM (SELECT b.CON_ID, b.owner,
         ...
         WHERE b.BYTES > 10*1024*1024
           ...
           AND  b.owner NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
prompt <b><font face="Consolas" color="#990000">NOTE</font>: Excluding all internal system schemas (i.e. CTXSYS, MDSYS, SYS, SYSTEM) ，SELECT top 100 rows </font></b>
...
SELECT *
  FROM (SELECT l.CON_ID, '<div nowrap align="left"><font color="#336699"><b>' ||
         ...
         WHERE l.owner = s.owner
           ...
           and  l.owner   NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')   
...
SELECT d.CON_ID, '<font color="#336699"><b>' || tablespace_name || '</b></font>' tablespace_name,
       ...
       count(*) seg_count
  FROM cdb_segments d
  WHERE  d.owner   NOT IN  ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT d.con_id, owner,
  ...
  FROM cdb_segments d
where  segment_type = 'TABLE' AND  owner  NOT IN  ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT *
  FROM (SELECT d.CON_ID, table_owner, table_name, count(*) cnt
          FROM cdb_tab_partitions  d
	  WHERE table_owner  NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')	
...
and  TABLE_OWNER NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT con_id, owner,
 ...
 WHERE col_cnt > ALL (SELECT count(*)
         ...
         WHERE i.table_name = cons.table_name
           ...
           AND  i.index_owner not IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT CON_ID, TABLE_OWNER,
  ...
  FROM (WITH TMP1 AS (SELECT I.CON_ID, I.OWNER INDEX_OWNER,
                       ...
                       AND S.CON_ID=I.CON_ID
                         ...
                         AND I.OWNER = S.OWNER
                         AND S.OWNER NOT IN  ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
  ...
  FROM (SELECT D.CON_ID, D.OBJECT_OWNER INDEX_OWNER,
          ...
          FROM CDB_HIST_SQL_PLAN D,
               CDB_HIST_SQLSTAT  H
         WHERE D.OBJECT_OWNER NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT di.owner index_owner,
  ...
  join (SELECT dic.CON_ID,index_name, table_name, INDEX_OWNER, count(*)
          FROM cdb_ind_columns dic
         where INDEX_OWNER not in ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')
 ...
 WHERE di.index_type != 'LOB'
   AND DI.owner not in ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')
...
SELECT di.owner index_owner,
  ...
  join (select DIS.CON_ID, DIS.STALE_STATS,dis.OWNER,dis.INDEX_NAME,DIS.TABLE_OWNER,DIS.TABLE_NAME from  cdb_ind_statistics dis
    where dis.OBJECT_TYPE = 'INDEX' and dis.STALE_STATS='YES' 
		AND DIS.OWNER  not in ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')) dict
...
--SELECT '<textarea cols="120" rows="10"> ' || message_text || '</textarea>'  message_text FROM T_ALERT_CHECKHELTH_CLOB_dhch;
--SELECT '<textarea style="width:100%;font-family:Consolas;font-size:12px;overflow:auto" rows="10"> ' || message_text || '</textarea>'  message_text FROM T_ALERT_CHECKHELTH_CLOB_dhch;
SET DEFINE OFF
...
SELECT t.CON_ID, sequence_owner, count(1) cnt
 ...
 WHERE cache_size < 20
   AND  sequence_owner NOT IN  ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT WB.*,
  ...
  FROM (SELECT DISTINCT d.CON_ID, D.EVENT,
         ...
         WHERE D.USER_ID = A.USER_ID   
           ...
           AND USERNAME NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT m.con_id, '<div align="left"><font color="#336699"><b>' || m.owner ||
  ...
  FROM cdb_mviews m
WHERE  m.OWNER NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')
...
SELECT t.CON_ID,
  ...
  FROM cdb_types t
WHERE t.owner NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG')
...
SELECT t.con_id,'<div nowrap align="left"><font color="#336699"><b>' || t.owner ||
 ...
 WHERE t.owner = m.owner
   ...
   AND  t.owner  NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
prompt <font size="+2" face="Consolas" color="#336699"><b>AWR Snapshot Size Estimates</b></font><hr align="left" width="300">
...
DECLARE
  task_name VARCHAR2(50) := 'HEALTH_CHECK_BY_dhch';
  task_desc VARCHAR2(50) := 'HEALTH_CHECK_BY_dhch';
  task_id   NUMBER;
begin
  begin
...
prompt 
prompt <b><font face="Consolas" color="#990000">NOTE</font>:　SQL脚本： SELECT dbms_advisor.get_task_report('HEALTH_CHECK_BY_dhch', 'TEXT', 'ALL') addm_results  FROM DUAL; </font></b>
SET MARKUP html TABLE  'width="60%" border="1" cellspacing="0px" style="border-collapse:collapse;" ' 
SELECT  '<textarea style="width:100%;font-family:Consolas;font-size:12px;overflow:auto" rows="10"> ' || dbms_advisor.get_task_report('HEALTH_CHECK_BY_dhch', 'TEXT', 'ALL') ||'</textarea>' addm_results  FROM DUAL;
SET MARKUP html TABLE  'width="auto" border="1" cellspacing="0px" style="border-collapse:collapse;" '
...
SELECT '<pre style="font-family:Consolas; word-wrap: break-word; white-space: pre-wrap; white-space: -moz-pre-wrap" >' || dbms_advisor.get_task_report('HEALTH_CHECK_BY_dhch', 'TEXT', 'ALL') || '</pre>' addm_results FROM DUAL;
alter session set nls_language='&_nls_language'; 
...
SELECT  /*+rule */ e.CON_ID, e.owner, e.segment_name, e.segment_type, sum(b.tch) sum_tch
     ...
     AND  e.owner   NOT IN  ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT a.con_id, '<div nowrap align="left"><font color="#336699"><b>' || index_owner ||'</b></font></div>' owner,
 ...
 WHERE last_analyzed IS NULL
   AND   index_owner   NOT IN  ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
prompt <font size="+2" face="Consolas" color="#336699"><b>需收集统计信息的表</b></font> [<a class="noLink" href="#statics_gatherfla_tmptable">下一项</a>] <hr align="left" width="600">
  ...
  FROM (SELECT b.con_id, b.INST_ID,
         ...
         WHERE a.sql_id = b.sql_id
           ...
           AND  a.INST_ID = b.INST_ID
					 ...
					 and a.con_id=b.con_id
           AND  c.username NOT IN ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
         ORDER BY CNT DESC) t,
       gv$session s
...
SELECT *
  FROM (SELECT p.INST_ID,
         ...
         WHERE s.paddr(+) = p.addr
           ...
           AND  s.USERNAME not in ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
SELECT a.INST_ID,
 ...
 WHERE B.ADDR = a.PADDR
   ...
   AND  rank_order <= 10
   AND  a.USERNAME not in  ('SYS','SYSTEM','PUBLIC','MDSYS','DBSNMP','SCOTT','dhch','dhch2','DB_MONITOR','OUTLN','MGMT_VIEW','FLOWS_FILES','ORDSYS','EXFSYS','WMSYS','APPQOSSYS','APEX_030200','OWBSYS_AUDIT','ORDDATA','CTXSYS','ANONYMOUS','SYSMAN','XDB','ORDPLUGINS','OWBSYS','SI_INFORMTN_SCHEMA','OLAPSYS','ORACLE_OCM','XS$NULL','BI','PM','MDDATA','IX','SH','DIP','OE','APEX_PUBLIC_USER','HR','SPATIAL_CSW_ADMIN_USR','SPATIAL_WFS_ADMIN_USR','APEX_040200','DVSYS','LBACSYS','GSMADMIN_INTERNAL','AUDSYS','OJVMSYS','SYS$UMF','GGSYS','DBSFWUSER','DVF','GSMCATUSER','SYSBACKUP','REMOTE_SCHEDULER_AGENT','GSMUSER','SYSRAC','SYSKM','SYSDG') 
...
prompt <font size="+1" face="Consolas" color="#336699"><b>● 等待事件（cdb_hist_active_sess_history）</b></font>
...
SELECT '<div align="center">' || rownuM || '</div>' ID,
 ...
 and a.con_id=b.con_id
 and round((a.all_bytes - b.FREESIZ) / a.all_bytes, 2) >= 0.96) > 0 then
                          (select 13 || '|' || 1 || '|' ||
                ...
                select case
                         when (SELECT COUNT(*) FROM v$pdbs a where a.OPEN_MODE in ('MOUNTED') or a.RESTRICTED='YES') > 0 then
                          (select 16 || '|' || 2 || '|' || '数据库总体概况.数据库基本信息.PDB情况' || '|' ||
                                  'PDB状态不正确' || '|' ||
                                  '<center>[<a class="noLink" href="#pdb_overview"><font size=1 face="Consolas" color="#336699"><b>参考：PDB情况</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
				  UNION ALL 
...
head ' -
  ...
  <style type="text/css"> -
    ...
    table             {font:11px Consolas; color:Black; background:#FFFFCC; padding:1px; margin:0px 0px 0px 0px;} -
	tr:nth-child(odd) {background:White;} -
    th                {font:bold 11px Consolas; color:White; background:#0066cc; padding:2px;} -
    h1                {font:bold 12pt Consolas; color:White; background-color:White; border-bottom:1px solid #cccc99; margin-top:0pt; margin-bottom:0pt; padding:0px 0px 0px 0px;} -
    h2                {font:bold 11pt Consolas; color:White; background-color:White; margin-top:4pt; margin-bottom:0pt;} -
    a a.link          {font:11px Consolas; color:#663300; margin-top:0pt; margin-bottom:0pt; vertical-align:middle;padding:4;} -
    a.noLink          {font:11px Consolas; color:#663300; text-decoration: underline; margin-top:0pt; margin-bottom:0pt; vertical-align:middle;padding:4;} -
    a.info:hover      {background:#eee;color:#000000; position:relative;} -
    a.info span       {display: none; } -
    a.info:hover span {font-size:11px!important; color:#000000; display:block;position:absolute;top:30px;left:40px;width:150px;border:1px solid #ff0000; background:#FFFF00; padding:1px 1px;text-align:left;white-space: pre} -
  </style>' -
body   'BGCOLOR="#C0C0C0"'
...
SELECT d.username,
       ...
       D.STATEMENT
  FROM  SPERRORLOG d
  WHERE identifier='dhch_DB_HEALTHCHECK';
